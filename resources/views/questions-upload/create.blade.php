    ...
    <div class="py-12" x-data="csvUploader()">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6 md:p-8">
                ...
                <form id="upload-form" action="{{ route('questions-upload.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
        ...
        <div x-show="templateModalOpen" 
            ...
            <div @click.away="templateModalOpen = false" 
                 ...
                 x-transition:leave-start="opacity-100 translate-y-0 sm:scale-100"
                 x-transition:leave-end="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95"
                 {{-- COMENTARIO: Ancho de la modal se mantiene en ~80% con sm:max-w-5xl y lg:max-w-5xl --}}
                ...
                <div class="p-6">
                    ...
                    <div x-data="{
                        ...
                        <textarea x-ref="templateText" id="content" 
                            name="content" 
                            rows="15" {{-- COMENTARIO: Aumentado el número de filas visibles inicialmente a 15 --}}
                            class="mt-1 block w-full font-mono text-sm border-gray-300 rounded-md shadow-sm whitespace-pre overflow-x-auto" {{-- COMENTARIO: Añadidas clases whitespace-pre y overflow-x-auto para mostrar líneas completas y permitir desplazamiento horizontal --}}
                            readonly>{{ old('content', $templateContent) }}
                        </textarea>
                    </div>
                </div>
