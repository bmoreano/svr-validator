                                        ...
                                        <div class="flex items-center justify-center space-x-2">
                                            @switch($question->status)
                                                ...
                                                @case('en_validacion_ai')
                                                    <div class="flex items-center space-x-2 text-yellow-600" title="Procesando validación con IA...">
                                                        <svg class="animate-spin h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>
                                                        <span class="text-xs font-semibold">Validando IA</span>
                                                    </div>
                                                    @break

                                                @case('en_validacion_comparativa')
                                                    {{-- Mantenemos el feedback de progreso para comparativa --}}
                                                    <div class="flex items-center space-x-3" title="Validación comparativa en proceso...">
                                                        {{-- ... iconos de progreso de GPT y Gemini ... --}}
                                                    </div>
                                                    @break

                                                @case('en_revision_humana')
                                                    <div class="flex items-center space-x-2 text-blue-600" title="Pregunta en revisión por un validador experto.">
                                                        <svg class="w-5 h-5" ...></svg><span class="text-xs font-semibold">En Revisión Humana</span></div>
                                                    @break
                                                ...
                                                {{-- ... (resto de los casos del switch sin cambios) ... --}}
                                            @endswitch
                                        </div>
                                    </td>
