                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                            ...
                                            @elseif($user->role === 'validador') bg-blue-100 text-blue-800
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex items-center justify-center space-x-4">
                                            @can('update', $user)
                                                <a href="{{ route('admin.users.edit', $user) }}" class="text-indigo-600 hover:text-indigo-900" title="Editar Usuario">
                                            ...
                                            @endcan
                                            @cannot('update', $user) @cannot('delete', $user)
                            ...
                            @empty
                                <tr><td colspan="4" class="px-6 py-12 text-center text-gray-500 italic">No hay otros usuarios en el sistema.</td></tr>
                            @endforelse
                        </tbody>
                    </table>
                </div>
