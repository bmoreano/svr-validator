            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
                    <div class="flex items-center">
                        <x-application-mark class="h-12 w-auto mr-4" />
                ...
                <div class="bg-gray-200 bg-opacity-25 p-6 lg:p-8 space-y-8">
                    ...
                    {{-- ==                SECCIÓN PARA AUTOR                 == --}}
                    {{-- ======================================================= --}}
                    {{-- Esta comprobación es segura porque el controlador siempre pasa $autorData --}}
                    @if(isset($autorData))
                        <div class="p-6 bg-white rounded-lg shadow-md border border-gray-200">
                            <h3 class="text-xl font-semibold text-gray-800 mb-4">Panel de Autor</h3>
                            
                            <!-- Tarjetas de Estadísticas del Autor (Línea ~38 aquí) -->
                        ...
                        <div class="p-6 bg-white rounded-lg shadow-md border border-gray-200">
                            ...
                            <div class="mt-2 bg-white border rounded-lg">
                                @forelse($validadorData['pending_validation'] as $question)
                                    <div class="flex justify-between items-center px-4 py-3 border-b last:border-b-0">
                                        <div>
                                            <p class="text-gray-800 truncate">{{ $question->stem }}</p>
                                ...
                                @empty
                                    <div class="px-4 py-3 text-center text-gray-500">
                                        <p>¡Buen trabajo! No hay preguntas pendientes de revisión.</p>
                                    </div>
                                @endforelse
                            </div>
                        </div>
                         ...
                         <div class="p-6 bg-white rounded-lg shadow-md border border-gray-200">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="bg-gray-700 p-6 rounded-lg text-white">
                                    ...
                                    <div class="text-lg mt-1">Total de Preguntas</div>
                                </div>
                                <div class="bg-gray-700 p-6 rounded-lg text-white">
                                    <div class="text-4xl font-bold">{{ $adminData['global_stats']['total_users'] }}</div>
                                    <div class="text-lg mt-1">Total de Usuarios</div>
                                </div>
                            </div>
                        </div>
                    @endif
